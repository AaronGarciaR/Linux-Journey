...
!Hola!, este repositorio es mi primer acercamiento a Github por lo cual (y por lo pronto) ire documentando los comandos que voy aprendiendo/practicando, notas o detalles importantes de mi aprendizaje de Linux, con la finalidad de desarrollarme como Cloud Engineer.

---

## 📊 Progreso en LabEx (Mi principal herramienta de aprendizaje y practica)
- [x] **Linux Quick Start** 📜
- [x] **Become a Junior System Administrator** 🛠️
- [ ] **Linux para Principiantes (En marcha)
- [ ] **AWS Educate: Introduction to Cloud 101** ☁️ (Curso paralelo)
